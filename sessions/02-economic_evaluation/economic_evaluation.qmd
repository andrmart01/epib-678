...
-   Uncertainty distribution for average cost may be right-skewed too (but less so)

## Health resources and costs data sources

-   [**Public information:**]{.underline} provincial drug formularies; hospitalization costs published by Canadian Institute for Health Information (CIHI)

-   [**Other publications**]{.underline} may need inflation or currency adjustment

-   [**Administrative data:**]{.underline} encounters (clinic, emergency room, hospital) & procedures. Follow patients across care settings

-   [**Clinical data:**]{.underline} labs, drugs, transfusions. Usually for one care setting.
...
-   Purchasing power parity (estimated cost of a basket of goods) recommended over exchange rate

-   Available in the [IMF World Economic Outlook Databases](https://www.imf.org/en/Publications/SPROLLs/world-economic-outlook-databases#sort=%40imfdate%20descending)
...
-   Average all-item consumer price index (CPI) recommended

-   \[Year Y cost\] = \[Year X cost\] x \[Year Y CPI\] / \[Year X CPI\]

-   Available [from the Statistics Canada website](https://www150.statcan.gc.ca/t1/tbl1/en/cv.action?pid=1810000501)
...
-   Usually the largest non-health cost in societal perspective
...
-   There are arguments to include in cost-effectiveness analyses
...
[Link to session 1 slides on perspectives and audiences](https://htmlpreview.github.io/?https://github.com/altonrus/epib-678/blob/main/sessions/01-introduction/course-intro.html#/who-is-the-audience-of-a-decision-analysis)
...
-   Complete readings before Tuesday's class
-   Assignment 1 (cost-effectiveness and decision trees) available tomorrow.
    -   Due Friday, January 23 on MyCourses → Assignments
