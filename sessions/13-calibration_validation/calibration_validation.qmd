...
subtitle: "EPIB  676 session 13, McGill University"
...
[**https://doi.org/10.1002/sim.70039**](https://doi.org/10.1002/sim.70039)

RobustCalibration: Robust Calibration of Computer Models in R

<http://arxiv.org/abs/2201.01476>
...
Calibration identifies parameters that maximize **t**otal likelihood, [product of the likelihood]{.underline} of each target
...
-   **Probabilistic:** "What [distribution]{.underline} of parameters is [consistent with the uncertainty distributio]{.underline}n of my calibration targets"
...
-   Most lecturers joining via Zoom, but we will meet in the regular classroom
    ...
    -   [**Exceptions**]{.underline}: Tues Oct 22 and Tues Oct 29 will be Zoom only
