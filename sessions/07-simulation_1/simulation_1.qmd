...
Risks, costs, and health outcomes may depend on any variable you choose to track
...
Microsimulations simulate [stochasticity]{.underline}. Parametric uncertainty assessed through sensitivity analysis (planned for session 11)
...
-   Population estimates of interest should not depend on stochasticity (which patient or random numbers happened to be generate)
