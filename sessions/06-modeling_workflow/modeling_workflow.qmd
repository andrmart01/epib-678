...
## "Data available on reasonable request"[^1]

-   3416 of 3556 articles (96%) in BMC-family journals pubilshed in Jan 2019 included data availability statements
...
[^1]: Gabelica, Bojčić, and Puljakc 2022. *Journal of Clinical Epidemiology* 2022. <https://doi.org/10.1016/j.jclinepi.2022.05.019>
...
Data sharing isn't always ethical or permissible
...
-  Can set global options to maximize reproducibility
...
-  On new machine (with Linux), you can load the container based on the image
...
-   Two options
   ...
   - Upload manually 
   - Link Github account and auto-update Zenodo whenever making a 'release' on Github
   
## Quarto Manuscripts

Nice system. I will likely change my template to use this (eventually)
...
-  [Quarto journal extensions](https://quarto.org/docs/extensions/listing-journals.html)

## Logistics

-   Complete readings before next class
-   **Assignment 1** due Friday, January 23 ~~on MyCourses → Assignments~~
    -   [**New process:**]{.underline} submit Assignment 0 & 1 by uploading to OneDrive folder shared with you by Friday
-   **Assignment 2** Cohort state transition models due Friday, January 30
    -   **More time consuming than usual**
    -   Suggest starting before Monday's office hours
