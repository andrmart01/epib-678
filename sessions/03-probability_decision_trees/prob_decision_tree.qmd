...
## Printing lecture slides to PDF
...
2.  Open the in-browser print dialog `COMMAND+P`.
...
-   [Wrapping up incremental analysis](https://htmlpreview.github.io/?https://github.com/altonrus/epib-678/blob/main/sessions/02-economic_evaluation/economic_evaluation.html#/evaluating-2-alternatives)

-   Key probability concepts

-   Decision trees

Source: [quarto guides on Revealjs](https://quarto.org/docs/presentations/revealjs/presenting.html#print-to-pdf)
...
**Goal:** distribution describing my uncertainty in parameter $\theta$, after observing new data $x$, if my uncertainty before observing $x$ was described by $P(\theta)$
...
[www.r-bloggers.com/2020/04/an-animated-example-of-bayesian-updating/](https://www.r-bloggers.com/2020/04/an-animated-example-of-bayesian-updating/)
